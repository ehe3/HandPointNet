...
def preprocess(depth_map_path, gt_path, add_noise=False):
    ...
    if add_noise: 
        mean = np.random.uniform(-0.025, 0.025)
        std = np.random.uniform(5e-3, 0.12)
...
if __name__ == "__main__":
    data_root = '/Volumes/AndrewJayZhou/Dataset/FootPoseDepth/syn/v4'
    save_root = '/Volumes/AndrewJayZhou/Dev/HandPointNet/data/v4'
